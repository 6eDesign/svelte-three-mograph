/* src/components/primitives/Cube.svelte generated by Svelte v3.31.2 */
import {
	SvelteComponent,
	assign,
	create_component,
...
import { BoxBufferGeometry } from "../../../web_modules/three.js";
...
function create_fragment(ctx) {
	...
	return {
		...
		p(ctx, [dirty]) {
			const primitive_changes = (dirty & /*BoxBufferGeometry, $$props, sizeAsArray*/ 3)
			? get_spread_update(primitive_spread_levels, [
					dirty & /*BoxBufferGeometry*/ 0 && { Geometry: BoxBufferGeometry },
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty & /*size*/ 4) {
			$: $$invalidate(0, sizeAsArray = Array.isArray(size) ? size : [size, size, size]);
		}
	};
