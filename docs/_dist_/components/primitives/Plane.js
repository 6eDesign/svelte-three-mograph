/* src/components/primitives/Plane.svelte generated by Svelte v3.31.2 */
import {
	SvelteComponent,
	assign,
	create_component,
...
import { PlaneBufferGeometry } from "../../../web_modules/three.js";
...
function create_fragment(ctx) {
	...
	return {
		...
		p(ctx, [dirty]) {
			const primitive_changes = (dirty & /*PlaneBufferGeometry, $$props, size*/ 3)
			? get_spread_update(primitive_spread_levels, [
					dirty & /*PlaneBufferGeometry*/ 0 && { Geometry: PlaneBufferGeometry },
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$new_props => {
		...
		if ("widthSegments" in $$new_props) $$invalidate(4, widthSegments = $$new_props.widthSegments);
		if ("heightSegments" in $$new_props) $$invalidate(5, heightSegments = $$new_props.heightSegments);
	};

	$$self.$$.update = () => {
		if ($$self.$$.dirty & /*width, height, widthSegments, heightSegments*/ 60) {
			$: $$invalidate(0, size = [width, height, widthSegments, heightSegments]);
		}
	};

	$$props = exclude_internal_props($$props);
	return [size, $$props, width, height, widthSegments, heightSegments];
}
