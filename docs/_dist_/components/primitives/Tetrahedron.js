/* src/components/primitives/Tetrahedron.svelte generated by Svelte v3.31.2 */
import {
	SvelteComponent,
	assign,
	create_component,
...
import { TetrahedronBufferGeometry } from "../../../web_modules/three.js";
...
function create_fragment(ctx) {
	...
	const primitive_spread_levels = [
		{ Geometry: TetrahedronBufferGeometry },
		/*$$props*/ ctx[1],
	...
	return {
		...
		p(ctx, [dirty]) {
			const primitive_changes = (dirty & /*TetrahedronBufferGeometry, $$props, sizeAsArray*/ 3)
			? get_spread_update(primitive_spread_levels, [
					dirty & /*TetrahedronBufferGeometry*/ 0 && { Geometry: TetrahedronBufferGeometry },
...
class Tetrahedron extends SvelteComponent {
	constructor(options) {
		super();
